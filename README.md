...
Semantic Html is Html with meaning.  <address> instead of <div> for example.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Block has 100% width --- Inline is the width of the element.  
Block may have assigned width and height --- Inline cannot.
...
It's used to avoid conflicts, track history / changes, and also helps for security purposes.
